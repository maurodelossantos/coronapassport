...
public class MedicalRecord5 extends Contract {
    ...
    @Deprecated
    protected MedicalRecord5(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected MedicalRecord5(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected MedicalRecord5(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected MedicalRecord5(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public List<PatientRecordAccesedEventResponse> getPatientRecordAccesedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse._dosisRecibidas = (List<Dosis>) eventValues.getNonIndexedValues().get(9).getValue();
            typedResponse._pruebasRealizadas = (List<Prueba>) eventValues.getNonIndexedValues().get(10).getValue();
            typedResponse._reaccionesAdversas = (List<String>) eventValues.getNonIndexedValues().get(11).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    @Deprecated
    public static MedicalRecord5 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new MedicalRecord5(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static MedicalRecord5 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new MedicalRecord5(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static MedicalRecord5 load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new MedicalRecord5(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static MedicalRecord5 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new MedicalRecord5(contractAddress, web3j, transactionManager, contractGasProvider);
    }

    public static class Dosis extends DynamicStruct implements Parcelable, Type<List<Type>> {
    ...
    public static class Prueba extends DynamicStruct implements Parcelable, Type<List<Type>>{
    ...
    public static class PatientRecordAccesedEventResponse extends BaseEventResponse {
        ...
        public List<Dosis> _dosisRecibidas;

        public List<Prueba> _pruebasRealizadas;
